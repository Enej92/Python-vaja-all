...
#with open("Human characteristics.json", "r") as char_file:
#    characteristics = json.loads(char_file.read())

#with open("Suspects.json", "r") as suspect_file:
#    suspects = json.loads(suspect_file.read())
